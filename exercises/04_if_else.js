...
/*  a) Create a random number between 0 and 1 using the function Math.random(),
if the value is greater or equal than 0,5 show an alert with the message
'Greater than 0,5' and if not an alert with the message 'Lower than 0,5'. */
...
/*  b) Create a variable 'Age' with a integer number between 0 and 100 and show
the next alert messages:
